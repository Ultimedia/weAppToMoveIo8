<?php
	...
	$sql = "SELECT * FROM watm_activities
			...
			LEFT JOIN watm_activity_users ON watm_activities.activity_id = watm_activity_users.activity_id
			WHERE watm_activities.visible = 1 and watm_activity_users.user_id =" . $user_id . " and watm_activity_users.going = 1 and date >= CURRENT_DATE() ORDER BY date";
